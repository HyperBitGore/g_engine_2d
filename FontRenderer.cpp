...
void FontRenderer::loadFont(std::string file) {
	//define the hashmap of functions
	Gore::HashMap<std::function<void(char*)>> map;
	map.insert("cmap", std::function<void(char*)>(readCmap));
